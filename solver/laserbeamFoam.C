...
int main(int argc, char *argv[])
{
    ...
    while (pimple.run(runTime))
    {
        ...
        while (pimple.loop())
        {
            ...
            Info << "&&& alpha1 1 &&& alpha1 Sum: " << gSum(alpha1.internalField()) << endl;
            #include "alphaControls.H"
            #include "alphaEqnSubCycle.H"
			scalar time3 = runTime.elapsedCpuTime();
            Info << "&&& alpha1 2 &&& alpha1 Sum: " << gSum(alpha1.internalField()) << endl;
		    ...
		    Info << "3. evap, updateProps: " << time4 - time3 << endl;
